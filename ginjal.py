...
with col1:
    ...
    alcohol_consumption = st.selectbox('Konsumsi Alkohol (0-20)', min_value=0.0, max_value=20.0, step=0.1, format="%.2f")
...
with col2:
    ...
    nausea_vomiting = st.selectbox('Mual & Muntah (0-7)', min_value=0, max_value=7)
    muscle_cramps = st.selectbox('Kram Otot (0-7)', min_value=0, max_value=7)
    itching = st.selectbox('Gatal-gatal (0-10)', min_value=0, max_value=10)
    ...
    water_quality = st.number_input('Kualitas Air (0: Baik, 1: Buruk)', [0, 1])
